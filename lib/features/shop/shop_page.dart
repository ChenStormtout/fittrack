...
class ProductModel {
  ...
  double get finalPrice => isPromo && discountPercent != null
      ? priceIdr * (1 - discountPercent! / 100)
      : priceIdr;

  String get photoUrl {
    final query = _productImageQueries[id] ?? '$name fitness product';
...
const Map<int, String> _productImageQueries = {
  1: 'resistance band fitness product',
  2: 'adjustable dumbbells gym equipment',
  3: 'olympic barbell gym equipment',
  4: 'doorway pull up bar fitness',
  5: 'kettlebell gym equipment',
  6: 'weight plates gym equipment',
  7: 'push up board fitness product',
  8: 'wooden gymnastic rings fitness',
  9: 'running shoes product',
  10: 'speed jump rope fitness',
  11: 'agility ladder training equipment',
  12: 'boxing gloves product',
  13: 'boxing speed bag product',
  14: 'badminton racket product',
  15: 'basketball product',
  16: 'turf soccer cleats product',
  17: 'yoga mat product',
  18: 'cork yoga block product',
  19: 'yoga strap product',
  20: 'pilates ring product',
  21: 'gym balance ball product',
  22: 'meditation cushion product',
  23: 'yoga wheel product',
  24: 'fitness smartwatch product',
  25: 'fitness tracker band product',
  26: 'sport wireless earbuds product',
  27: 'smart body scale product',
  28: 'pulse oximeter product',
  29: 'blood pressure monitor product',
  30: 'gym interval timer product',
  31: 'protein shaker bottle product',
  32: 'stainless gym water bottle product',
  33: 'meal prep containers product',
  34: 'pill supplement organizer product',
  35: 'digital kitchen scale product',
  36: 'foam roller product',
  37: 'massage gun product',
  38: 'reusable ice pack gel product',
  39: 'knee compression sleeve product',
  40: 'lacrosse massage ball product',
  41: 'dry fit training shirt product',
  42: 'compression leggings workout product',
  43: 'sports bra product',
  44: 'gym shorts product',
  45: 'sweat headband product',
  46: 'gym duffel bag product',
  47: 'weightlifting belt product',
  48: 'gym gloves wrist wraps product',
  49: 'yoga towel product',
  50: 'gym chalk ball magnesium product',
};
...
extension PaymentMethodExt on PaymentMethod {
  ...
  String get description {
    switch (this) {
      case PaymentMethod.cod:
        return 'Bayar tunai saat barang tiba';
      case PaymentMethod.qris:
        return 'Scan QR dari semua dompet digital';
      case PaymentMethod.transfer:
        return 'Transfer via ATM / m-Banking';
      case PaymentMethod.creditCard:
...
const List<ProductModel> allProducts = [
  ...
  ProductModel(
    ...
    description: 'Elastic band graded untuk kekuatan dan rehabilitasi otot.',
    priceIdr: 150000,
    rating: 4.7,
    stock: 20,
    emoji: '🏋️',
  ...
  ProductModel(
    ...
    description: 'Dumbbell adjustable 2–24 kg, ideal untuk home workout.',
    priceIdr: 950000,
    rating: 4.5,
    stock: 15,
    emoji: '💪',
    category: 'Kekuatan',
    imageUrl:
        'https://images.unsplash.com/photo-1586401100295-7a8096fd231a?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 3,
    name: 'Barbell Olympic 20 kg',
    description: 'Barbell baja 20 kg standar olimpiade, grip knurling.',
    priceIdr: 1800000,
    rating: 4.6,
    stock: 8,
    emoji: '🏗️',
  ...
  ProductModel(
    ...
    description: 'Bar pull-up multifungsi tanpa bor, kapasitas 120 kg.',
    priceIdr: 280000,
    rating: 4.4,
    stock: 30,
    emoji: '🔧',
    category: 'Kekuatan',
    imageUrl:
        'https://images.unsplash.com/photo-1598971639058-a6a0e040e4b3?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 5,
    name: 'Kettlebell 16 kg',
    description: 'Kettlebell cast iron 16 kg dengan pelapis rubber.',
    priceIdr: 420000,
    rating: 4.5,
    stock: 18,
    emoji: '⚫',
  ...
  ProductModel(
    id: 6,
    name: 'Weight Plate 10 kg (pair)',
    description: 'Piringan besi 10 kg standar 50 mm, satu pasang.',
    priceIdr: 350000,
    rating: 4.3,
    stock: 25,
    emoji: '🔘',
    ...
    discountPercent: 5,
    imageUrl:
        'https://images.unsplash.com/photo-1521804906057-1df8fdb718b7?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 7,
    name: 'Push-Up Board Multigrip',
    description: 'Board push-up 9 posisi untuk menarget otot berbeda.',
    priceIdr: 175000,
    rating: 4.4,
    stock: 40,
    emoji: '🟦',
  ...
  ProductModel(
    id: 8,
    name: 'Gymnastic Rings Wood',
    description: 'Ring kayu 32 mm dengan tali nilon adjustable.',
    priceIdr: 310000,
    rating: 4.7,
    stock: 12,
    emoji: '⭕',
    category: 'Kekuatan',
    imageUrl:
        'https://images.unsplash.com/photo-1597452485669-2c7bb5fef90d?w=300&h=300&fit=crop',
  ),
  ...
  ProductModel(
    ...
    description: 'Sepatu lari ringan 220 g dengan teknologi foam cushion.',
    priceIdr: 580000,
    rating: 4.8,
    stock: 30,
    emoji: '👟',
  ...
  ProductModel(
    ...
    description: 'Skipping rope kabel baja dengan bearing presisi tinggi.',
    priceIdr: 95000,
    rating: 4.5,
    stock: 50,
    emoji: '🪢',
    category: 'Olahraga',
    imageUrl:
        'https://images.unsplash.com/photo-1601422407692-ec4eeec1d9b3?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 11,
    name: 'Agility Ladder 6 m',
    description: 'Tangga kelincahan 6 m untuk latihan footwork & speed.',
    priceIdr: 140000,
    rating: 4.3,
    stock: 22,
    emoji: '🪜',
    category: 'Olahraga',
    imageUrl:
        'https://images.unsplash.com/photo-1599058917212-d750089bc07e?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 12,
    name: 'Boxing Gloves 12 oz',
    description: 'Sarung tinju kulit sintetis 12 oz, padding tebal.',
    priceIdr: 380000,
    rating: 4.6,
    stock: 16,
    emoji: '🥊',
    category: 'Olahraga',
    imageUrl:
        'https://images.unsplash.com/photo-1509255174576-83c14b3a3122?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 13,
    name: 'Speed Ball Boxing',
    description: 'Speed ball pantulan cepat untuk latihan reflex.',
    priceIdr: 265000,
    rating: 4.2,
    stock: 14,
    emoji: '🟤',
  ...
  ProductModel(
    ...
    description: 'Raket karbon ringan 82 g, tension 26 lbs.',
    priceIdr: 450000,
    rating: 4.5,
    stock: 20,
    emoji: '🏸',
    category: 'Olahraga',
    imageUrl:
        'https://images.unsplash.com/photo-1613918431703-aa50889e3be4?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 15,
    name: 'Basketball Spalding',
    description: 'Bola basket ukuran 7, indoor/outdoor rubber.',
    priceIdr: 320000,
    rating: 4.4,
    stock: 18,
    emoji: '🏀',
  ...
  ProductModel(
    id: 16,
    name: 'Soccer Cleats Turf',
    description: 'Sepatu futsal turf dengan sol karet multidirectional.',
    priceIdr: 420000,
    rating: 4.3,
    stock: 25,
    emoji: '⚽',
  ...
  ProductModel(
    id: 17,
    name: 'Yoga Mat Premium 6 mm',
    description: 'Mat yoga TPE anti-slip 6 mm, ramah lingkungan.',
    priceIdr: 220000,
    rating: 4.7,
    stock: 35,
    emoji: '🧘',
  ...
  ProductModel(
    id: 18,
    name: 'Yoga Block Cork (pair)',
    description: 'Blok yoga gabus alami 1 pasang, density tinggi.',
    priceIdr: 120000,
    rating: 4.6,
    stock: 40,
    emoji: '🟫',
  ...
  ProductModel(
    id: 19,
    name: 'Yoga Strap 2.5 m',
    description: 'Tali yoga nilon 2,5 m dengan gesper logam tahan lama.',
    priceIdr: 65000,
    rating: 4.4,
    stock: 60,
    emoji: '🔵',
  ...
  ProductModel(
    id: 20,
    name: 'Pilates Ring 38 cm',
    description: 'Ring pilates 38 cm dengan foam padded grip nyaman.',
    priceIdr: 145000,
    rating: 4.3,
    stock: 28,
    emoji: '🔴',
  ...
  ProductModel(
    id: 21,
    name: 'Balance Ball 65 cm',
    description: 'Bola gym 65 cm anti-burst untuk core dan pilates.',
    priceIdr: 195000,
    rating: 4.5,
    stock: 22,
    emoji: '🟡',
    category: 'Yoga',
    imageUrl:
        'https://images.unsplash.com/photo-1620188467120-5042ed1eb5da?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 22,
    name: 'Meditation Cushion',
    description: 'Bantal meditasi kapas organik, ketebalan 15 cm.',
    priceIdr: 175000,
    rating: 4.6,
    stock: 30,
    emoji: '🪷',
  ...
  ProductModel(
    id: 23,
    name: 'Yoga Wheel 33 cm',
    description: 'Wheel yoga 33 cm untuk backbend dan fleksibilitas.',
    priceIdr: 240000,
    rating: 4.4,
    stock: 18,
    emoji: '🎡',
    category: 'Yoga',
    imageUrl:
        'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=300&h=300&fit=crop',
  ),
  ...
  ProductModel(
    ...
    description: 'GPS built-in, monitor HR & SpO2, waterproof 5ATM.',
    priceIdr: 1500000,
    rating: 4.9,
    stock: 12,
    emoji: '⌚',
  ...
  ProductModel(
    ...
    description: 'Band fitness tipis dengan notifikasi & sleep tracking.',
    priceIdr: 380000,
    rating: 4.5,
    stock: 20,
    emoji: '📿',
  ...
  ProductModel(
    ...
    description: 'TWS earbuds IP68, ANC, latency rendah untuk workout.',
    priceIdr: 650000,
    rating: 4.7,
    stock: 15,
    emoji: '🎧',
  ...
  ProductModel(
    ...
    description: 'Timbangan pintar Bluetooth, ukur 13 parameter tubuh.',
    priceIdr: 420000,
    rating: 4.6,
    stock: 18,
    emoji: '⚖️',
    category: 'Teknologi',
    imageUrl:
        'https://images.unsplash.com/photo-1576511495709-b25dd6e750d5?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 28,
    name: 'Pulse Oximeter Clip',
    description: 'Oximeter jari compact, baca SpO2 & BPM real-time.',
    priceIdr: 125000,
    rating: 4.4,
    stock: 35,
    emoji: '🩺',
  ...
  ProductModel(
    ...
    description: 'Tensimeter digital otomatis, memori 200 data.',
    priceIdr: 350000,
    rating: 4.5,
    stock: 14,
    emoji: '💊',
  ...
  ProductModel(
    id: 30,
    name: 'Gym Timer LED',
    description: 'Timer interval LED 7-segment besar, remote control.',
    priceIdr: 280000,
    rating: 4.3,
    stock: 10,
    emoji: '⏱️',
  ...
  ProductModel(
    id: 31,
    name: 'Protein Shaker 700 ml',
    description: 'Shaker BPA-free dengan mixer ball stainless steel.',
    priceIdr: 85000,
    rating: 4.4,
    stock: 60,
    emoji: '🥤',
    category: 'Nutrisi',
    imageUrl:
        'https://images.unsplash.com/photo-1593095948071-474c5cc2c458?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 32,
    name: 'Gym Water Bottle 1 L',
    description: 'Botol vacuum insulated 1 L, keep cold 24 jam.',
    priceIdr: 145000,
    rating: 4.6,
    stock: 45,
    emoji: '💧',
  ...
  ProductModel(
    ...
    description: 'Set 5 wadah meal prep BPA-free, microwave safe.',
    priceIdr: 95000,
    rating: 4.3,
    stock: 50,
    emoji: '🍱',
  ...
  ProductModel(
    id: 34,
    name: 'Supplement Organizer',
    description: 'Kotak suplemen 7 hari, 4 kompartemen per hari.',
    priceIdr: 75000,
    rating: 4.2,
    stock: 40,
    emoji: '🗂️',
  ...
  ProductModel(
    ...
    description: 'Timbangan makanan digital presisi 1 g, maks 5 kg.',
    priceIdr: 110000,
    rating: 4.5,
    stock: 35,
    emoji: '🍽️',
    category: 'Nutrisi',
    imageUrl:
        'https://images.unsplash.com/photo-1574226516831-e1dff420e562?w=300&h=300&fit=crop',
  ),
  ...
  ProductModel(
    ...
    description: 'Foam roller tekstur bumps untuk deep tissue massage.',
    priceIdr: 195000,
    rating: 4.6,
    stock: 25,
    emoji: '🫀',
    category: 'Recovery',
    imageUrl:
        'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 37,
    name: 'Massage Gun Pro',
    description: 'Pistol pijat 6 kepala, 3200 RPM, baterai 8 jam.',
    priceIdr: 850000,
    rating: 4.8,
    stock: 10,
    emoji: '🔫',
  ...
  ProductModel(
    id: 38,
    name: 'Ice Pack Gel Reusable',
    description: 'Kompres gel reusable panas/dingin, isi 4 pack.',
    priceIdr: 65000,
    rating: 4.3,
    stock: 55,
    emoji: '🧊',
  ...
  ProductModel(
    ...
    description: 'Sleeve lutut neoprene untuk support sendi lutut.',
    priceIdr: 115000,
    rating: 4.5,
    stock: 38,
    emoji: '🦵',
    category: 'Recovery',
    imageUrl:
        'https://images.unsplash.com/photo-1434682881908-b43d0467b798?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 40,
    name: 'Lacrosse Ball Massage',
    description: 'Bola karet padat untuk trigger point myofascial.',
    priceIdr: 45000,
    rating: 4.4,
    stock: 70,
    emoji: '⚪',
    category: 'Recovery',
    imageUrl:
        'https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?w=300&h=300&fit=crop',
  ),

  // ── Pakaian (5)
  ProductModel(
    id: 41,
    name: 'Dry-Fit Training Shirt',
    description: 'Kaos latihan quick-dry moisture wicking, anti-bau.',
    priceIdr: 180000,
    rating: 4.5,
    stock: 45,
    emoji: '👕',
  ...
  ProductModel(
    ...
    description: 'Legging kompresi high-waist, 4-way stretch, UPF50.',
    priceIdr: 245000,
    rating: 4.6,
    stock: 30,
    emoji: '🩱',
  ...
  ProductModel(
    ...
    description: 'Sport bra high-impact tanpa wire, full coverage.',
    priceIdr: 195000,
    rating: 4.7,
    stock: 28,
    emoji: '👙',
    category: 'Pakaian',
    imageUrl:
        'https://images.unsplash.com/photo-1571731956672-f2b94d7dd0cb?w=300&h=300&fit=crop',
  ),
  ProductModel(
    id: 44,
    name: 'Gym Shorts 5 inch',
    description: 'Celana pendek gym dengan liner internal dan pocket.',
    priceIdr: 160000,
    rating: 4.4,
    stock: 40,
    emoji: '🩳',
  ...
  ProductModel(
    id: 45,
    name: 'Sweat Headband Set',
    description: 'Set 3 headband anti-keringat elastis, multicolor.',
    priceIdr: 55000,
    rating: 4.2,
    stock: 65,
    emoji: '🎀',
    category: 'Pakaian',
    imageUrl:
        'https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=300&h=300&fit=crop',
  ),

  // ── Perlengkapan (5)
  ProductModel(
    id: 46,
    name: 'Gym Bag Duffel 40 L',
    description: 'Tas gym waterproof 40 L dengan kompartemen sepatu.',
    priceIdr: 320000,
    rating: 4.6,
    stock: 20,
    emoji: '👜',
  ...
  ProductModel(
    ...
    description: 'Sabuk angkat besi kulit asli 10 cm, lumbar support.',
    priceIdr: 480000,
    rating: 4.7,
    stock: 12,
    emoji: '🟤',
  ...
  ProductModel(
    id: 48,
    name: 'Gym Gloves Wrist Wrap',
    description: 'Sarung tangan gym + wrist wrap velcro, palm guard.',
    priceIdr: 140000,
    rating: 4.5,
    stock: 35,
    emoji: '🧤',
  ...
  ProductModel(
    id: 49,
    name: 'Yoga Towel Microfiber',
    description: 'Handuk yoga microfiber anti-slip 63×183 cm.',
    priceIdr: 110000,
    rating: 4.4,
    stock: 42,
    emoji: '🏖️',
  ...
  ProductModel(
    id: 50,
    name: 'Chalk Ball Magnesium',
    description: 'Bola kapur magnesium 56 g untuk grip barbel & pullup.',
    priceIdr: 35000,
    rating: 4.6,
    stock: 80,
    emoji: '⬜',
...
class _ProductPhoto extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final baseSize = height ?? width ?? 80;
    final iconSize = min(baseSize * 0.42, 54.0);
    final badgeSize = min(baseSize * 0.64, 76.0);
      ...
      child: Container(
        ...
        child: Center(
          child: Container(
            ...
            child: Icon(product.icon, color: AppColors.primary, size: iconSize),
          ),
        ),
      ),
    );
...
class _ShopPageState extends State<ShopPage>
  ...
  double get _totalPrice =>
      _cart.fold(0.0, (s, i) => s + i.product.finalPrice * i.quantity);
  ...
  List<ProductModel> get _filtered {
    ...
    switch (_sort) {
      ...
      case 'Rating ↓':
        ...
        break;
      case 'Promo':
        list = list.where((p) => p.isPromo).toList();
        break;
    }
    return list;
  }
  ...
  List<Color> _grad(String cat) {
    ...
    return (m[cat] ?? [const Color(0xFFE8F5E9), const Color(0xFFC8E6C9)])
        .cast<Color>();
  }
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(
              '${_filtered.length} produk • ${allProducts.where((p) => p.isPromo).length} promo',
              style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (p.isPromo && p.discountPercent != null) ...[
                    Text(
                      _currency.format(p.priceIdr, _selCur),
                      style: const TextStyle(
                        fontSize: 10,
                        color: AppColors.textSecondary,
                    ...
                    Text(
                      _currency.format(p.finalPrice, _selCur),
                      style: const TextStyle(
                        fontSize: 13,
                        fontWeight: FontWeight.w800,
            ...
            Stack(
              children: [
                Container(
                  ...
                  height: 68,
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: _grad(p.category)),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: _ProductPhoto(
                    product: p,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 2),
                Text(
                  'Subtotal: ${_currency.format(p.finalPrice * item.quantity, _selCur)}',
                  style: const TextStyle(
                    fontSize: 10,
                    color: AppColors.textSecondary,
                  ),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(
              _currency.format(_totalPrice, _selCur),
              style: const TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w800,
                color: AppColors.textPrimary,
  ...
  void _openCheckout() => showModalBottomSheet(
    ...
    builder: (_) => _CheckoutSheet(
      ...
      currency: _currency,
      selCur: _selCur,
      onConfirm: (checkout) async {
        final productNames = _cart
            .map((c) => '${c.product.name} (x${c.quantity})')
            .toList();
        await OrderHistoryStore.instance.addOrder(
          OrderHistoryItem(
            orderId: OrderHistoryStore.generateId(),
            productNames: productNames,
            totalItems: _totalItems,
            totalPrice: _totalPrice,
            orderDate: DateTime.now(),
            status: OrderStatus.packed,
            paymentMethod: checkout.method.label,
        ...
        _snack(
          'Pembayaran berhasil. Pesanan masuk ke riwayat.',
          AppColors.primary,
        );
      },
    ),
                    ...
                    if (product.isPromo)
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            'PROMO ${product.discountPercent!.toInt()}% OFF',
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 11,
                              fontWeight: FontWeight.w800,
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                FittedBox(
                                  child: Text(
                                    currency.format(product.finalPrice, cur),
                                    style: const TextStyle(
                                      fontSize: 11,
                                      fontWeight: FontWeight.bold,
                                      color: AppColors.primary,
...
class _CheckoutSheet extends StatefulWidget {
  ...
  final CurrencyService currency;
  final String selCur;
  final Future<void> Function(_CheckoutResult checkout) onConfirm;
...
class _CheckoutSheetState extends State<_CheckoutSheet> {
  ...
  Widget _payStep() => Column(
    ...
    children: [
      ...
      const SizedBox(height: 4),
      Text(
        'Total: ${widget.currency.format(widget.totalPrice, widget.selCur)}',
  ...
  Widget _secLabel(String s) => Padding(
  ...
  Widget _payTile(PaymentMethod m) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            SizedBox(width: 32, height: 32, child: m.iconWidget),
  ...
  Widget _qrisMock() => Container(
    ...
    child: Column(
      children: [
        ...
        const SizedBox(height: 4),
        Text(
          widget.currency.format(widget.totalPrice, widget.selCur),
          style: const TextStyle(
            fontSize: 14,
            fontWeight: FontWeight.w800,
            color: AppColors.primary,
        ...
        Container(
          ...
          child: const Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Siapkan uang pas saat kurir tiba di lokasi Anda.',
                  style: TextStyle(
                    fontSize: 12,
                    color: AppColors.textSecondary,
                  ),
  ...
  Future<void> _finishCheckout() async {
    ...
    if (_isProcessing || method == null) return;
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Pembayaran gagal diproses. Silakan coba lagi.'),
        ),
      );
    }
  }
  ...
  Widget _bottomBtn() {
    ...
    if (_step == 0) {
      ...
      onTap = enabled ? _finishCheckout : null;
    }
